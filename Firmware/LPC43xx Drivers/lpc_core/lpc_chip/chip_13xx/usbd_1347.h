/*
 * @brief LPC1347 USB device register block
 *
 * @note
...
#ifndef __USBD_1347_H_
#define __USBD_1347_H_

#ifdef __cplusplus
extern "C" {
#endif

/** @defgroup USBD_1347 CHIP: LPC1347 USB device register block
 * @ingroup CHIP_13XX_Drivers
 * @{
 */

/**
 * @brief LPC1347 USB device register block structure
 */
