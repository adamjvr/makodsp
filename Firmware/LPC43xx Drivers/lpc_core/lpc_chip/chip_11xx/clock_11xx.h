...
/** @defgroup CLOCK_11XX_OPTIONS CHIP: LPC11xx Clock Control driver options
 * @ingroup CHIP_11XX_DRIVER_OPTIONS CLOCK_11XX
 ...
 * This define is rate of the input clock signal on the CLKIN input of the device (on some
 * parts only).<br>
 * @{
 */
...
typedef enum CHIP_SYSCTL_CLOCK {
	...
	SYSCTL_CLOCK_SSP1,					/*!< 18: SSP1 clock, LPC11A/C/E/Uxx only */
#if !defined(CHIP_LPC11CXX)
