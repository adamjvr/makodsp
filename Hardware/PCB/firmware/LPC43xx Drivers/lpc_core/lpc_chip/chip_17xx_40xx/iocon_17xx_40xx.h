...
#if defined(CHIP_LPC175X_6X)
#define IOCON_MODE_INACT        (0x2 << 0)		/*!< No addition pin function */
#define IOCON_MODE_PULLDOWN     (0x3 << 0)		/*!< Selects pull-down function */
#define IOCON_MODE_PULLUP       (0x0 << 0)		/*!< Selects pull-up function */
#define IOCON_MODE_REPEATER     (0x1 << 0)		/*!< Selects pin repeater function */
#else
