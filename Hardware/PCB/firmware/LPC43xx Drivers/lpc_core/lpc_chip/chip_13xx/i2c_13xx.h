 ...
 * (1 KHz to 1 MHz), as I2C0 support Fast Mode Plus. If @a clockrate
 * is above 400 KHz (Fast Plus mode), Board_I2C_EnableFastPlus()
 ...
 * the process repeats.
 */
void Chip_I2C_SlaveSetup(I2C_ID_T id, I2C_SLAVE_ID sid, I2C_XFER_T *xfer,
						 I2C_EVENTHANDLER_T event, uint8_t addrMask);
